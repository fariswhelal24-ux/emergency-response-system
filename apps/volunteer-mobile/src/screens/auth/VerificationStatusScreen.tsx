...
const copyMap: Record<VerificationStatus, { title: string; message: string }> = {
  pending: {
    ...
    message:
      "Your volunteer account is under review. You can log in, but response tools are locked until approval."
  },
  approved: {
    title: "Verification Approved",
    message: "Your account is approved. You can now access the full volunteer response workflow."
  },
  rejected: {
    title: "Verification Rejected",
    message:
      "Your last submission was rejected. Please update credentials and resubmit your application."
  }
};
